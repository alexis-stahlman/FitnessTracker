...
//            String printing = "";
//
//            for (int i = 0; i < totTimes.size(); i++) {
//                printing += totTimes.get(i).toString();
//                // printing += "\n";
//            }
//            arrayview.setText(printing);
    ...
    private void addRun()
    {
        if (selected_website != null) {
            ...
            datasource.addWebsite(ex, "" + time, "" + cals,
    ...
    public void show_list_layout()
    {
        ...
        showlist.setAdapter(new WebsiteItemAdapter(this,
                android.R.layout.simple_list_item_checked, this.tmp_websites));
    }
    ...
    public class WebsiteItemAdapter extends ArrayAdapter<WebsiteRecords> {
        ...
        public WebsiteItemAdapter(Context context, int textViewResourceId,
                List<WebsiteRecords> websites) {
        ...
        public View getView(int position, View convertView, ViewGroup parent)
        {
            ...
            if (website != null) {
                ...
                TextView tv_sitename = (TextView) view
                ...
                tv_username.setText("Duration  : " + website.getUsername()
                        + " minutes");
                tv_password.setText("Calories Burned : "
                        + website.getPassword() + " cal");

                if (selected_website != null) {
                    if (selected_website.getId() == website.getId())
